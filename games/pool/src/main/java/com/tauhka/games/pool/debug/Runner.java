...
public class Runner {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		/* SET2
		 * 
		 * cue.setAngle(0.034159369237127396d); cue.setForce(160d); turn.setCue(cue); p.playTurn(u, turn); Thread.sleep(2000);
		 * 
		 * cue.setAngle(0.9834061553082604d); cue.setForce(60d); turn.setCue(cue); p.playTurn(u2, turn); Thread.sleep(2000);
		 * 
		 * cue.setAngle(-3.1286069397220464d); cue.setForce(160d); turn.setCue(cue); p.playTurn(u, turn); Thread.sleep(2000); */
