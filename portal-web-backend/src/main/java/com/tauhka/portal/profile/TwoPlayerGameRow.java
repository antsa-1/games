...
@Entity
@Table(name = "game")
public class TwoPlayerGameRow implements Serializable {
	...
	private Double playerAStartRanking;
	...
	public Double getPlayerAStartRanking() {
		return playerAStartRanking;
	}

	public void setPlayerAStartRanking(Double playerAStartRanking) {
		this.playerAStartRanking = playerAStartRanking;
	}

	public Double getPlayerBStartRanking() {
		return playerBStartRanking;
	}

	public void setPlayerBStartRanking(Double playerBStartRanking) {
		this.playerBStartRanking = playerBStartRanking;
	}

	public Double getPlayerAEndRanking() {
		return playerAEndRanking;
	}

	public void setPlayerAEndRanking(Double playerAEndRanking) {
		this.playerAEndRanking = playerAEndRanking;
	}

	public Double getPlayerBEndRanking() {
		return playerBEndRanking;
	}

	public void setPlayerBEndRanking(Double playerBEndRanking) {
